...
### Tập dữ liệu tối giản {.unnumbered}  

Những người giúp bạn cần sử dụng dữ liệu của bạn - lý tưởng nhất là họ có thể tạo ra nó *bằng code*.  

Để tạo một tập dữ liệu tối thiểu, hãy xem xét việc ẩn danh và chỉ sử dụng một tập con của các quan sát. 

ĐANG ĐƯỢC PHÁT TRIỂN - Bạn có thể sử dụng lệnh `dput()` để tạo một bộ dữ liệu tối thiểu.  
