...
-   Có thể sử dụng trong các tình huống có kết nối internet thấp thông qua **[phiên bản ngoại tuyến][Download handbook and data]**
...
-   Kết hợp theo dõi cùng với các bộ [dữ liệu minh họa][Download handbook and data]\
-   Xem phần "Tài nguyên" trong từng trang để tìm thêm tài liệu

**Phiên bản ngoại tuyến**

Xem hướng dẫn tại trang [Download handbook and data].
