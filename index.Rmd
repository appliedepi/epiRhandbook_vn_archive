...
-   Có thể sử dụng trong các tình huống có kết nối internet thấp thông qua **[phiên bản ngoại tuyến][#page_dataused]**
...
-   Kết hợp theo dõi cùng với các bộ [dữ liệu minh họa][#page_dataused]\
-   Xem phần "Tài nguyên" trong từng trang để tìm thêm tài liệu

**Phiên bản ngoại tuyến**

Xem hướng dẫn tại trang [#page_dataused].
